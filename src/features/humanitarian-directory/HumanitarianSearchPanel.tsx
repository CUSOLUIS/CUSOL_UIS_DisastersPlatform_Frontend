...
const styles = StyleSheet.create({
  ...
  overline: { color: colors.cyan, fontFamily: fontFamilies.mono, fontSize: font(11), lineHeight: 16, fontWeight: "800", letterSpacing: 1.1 },
  ...
  publicText: { color: colors.alive, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "800", letterSpacing: 0.7 },
  kindOptions: { gap: 7 },
  ...
  kindOptionText: { color: colors.inkSoft, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "800", letterSpacing: 0.5 },
  ...
  filterLabel: { color: colors.inkDim, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "800", letterSpacing: 0.8 },
  filters: { gap: 7 },
  ...
  hint: { color: colors.inkDim, fontSize: font(11), lineHeight: 16 },
  ...
  closeButtonText: { color: colors.cyan, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "900" },
  modalScroll: { flex: 1 },
  ...
  resultsCount: { color: colors.cyan, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "900", letterSpacing: 0.8 },
  resultsQuery: { color: colors.ink, fontSize: 19, fontWeight: "700" },
  resultsNotice: { maxWidth: 380, color: colors.inkDim, fontSize: font(11), lineHeight: 15 },
  ...
  caseCode: { color: colors.missing, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "900" },
  kindBadge: { color: colors.cyan, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "900" },
  statusBadge: { color: colors.inkSoft, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "800", paddingHorizontal: 6, paddingVertical: 3, borderWidth: 1, borderColor: colors.line, borderRadius: 4 },
  statusMissing: { color: colors.missing, borderColor: "rgba(255,207,102,0.3)" },
  demoBadge: { color: colors.inkDim, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "800", paddingHorizontal: 5, paddingVertical: 3, borderWidth: 1, borderColor: colors.line, borderRadius: 4 },
  cardTitle: { marginTop: 5, color: colors.ink, fontSize: 20, fontWeight: "800", letterSpacing: -0.5 },
  cardSubtitle: { marginTop: 3, color: colors.inkSoft, fontSize: font(11), lineHeight: 15 },
  cardBody: { flex: 1, gap: 7, padding: 16 },
  cardLabel: { color: colors.inkDim, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "800", letterSpacing: 0.8 },
  cardValue: { color: colors.ink, fontSize: 13, fontWeight: "700" },
  cardDetail: { color: colors.inkSoft, fontSize: font(11), lineHeight: 16 },
  cardUpdated: { marginTop: 4, color: colors.inkDim, fontFamily: fontFamilies.mono, fontSize: font(11), lineHeight: 16 },
  aidStatusLine: { flexDirection: "row", flexWrap: "wrap", gap: 7 },
  verificationText: { color: colors.alive, fontSize: font(11), fontWeight: "800" },
  availabilityText: { color: colors.inkSoft, fontSize: font(11) },
  supplyTags: { flexDirection: "row", flexWrap: "wrap", gap: 5 },
  supplyTag: { color: colors.inkSoft, fontSize: font(11), paddingHorizontal: 7, paddingVertical: 4, borderWidth: 1, borderColor: colors.line, borderRadius: 999 },
  ...
  ratingText: { color: colors.inkSoft, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "800" },
  ...
  cardActionText: { color: colors.cyan, fontFamily: fontFamilies.mono, fontSize: font(11), fontWeight: "900", letterSpacing: 0.5 },
