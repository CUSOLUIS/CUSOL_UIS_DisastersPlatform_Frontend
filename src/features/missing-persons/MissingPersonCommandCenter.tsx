...
const styles = StyleSheet.create({
  ...
  overline: { marginBottom: 5, color: colors.cyan, fontFamily: fontFamilies.mono, fontSize: 8, fontWeight: "700", letterSpacing: 1.2 },
  ...
  publicText: { color: colors.alive, fontFamily: fontFamilies.mono, fontSize: 7, fontWeight: "700", letterSpacing: 0.8 },
  ...
  hint: { color: colors.inkDim, fontSize: 10, lineHeight: 17 },
  ...
  results: { gap: 8 },
  resultsCount: { color: colors.cyan, fontFamily: fontFamilies.mono, fontSize: 8, fontWeight: "700", letterSpacing: 1 },
  ...
  caseCode: { color: colors.missing, fontFamily: fontFamilies.mono, fontSize: 8, fontWeight: "800", letterSpacing: 0.7 },
  demoBadge: { color: colors.inkDim, fontFamily: fontFamilies.mono, fontSize: 7, borderWidth: 1, borderColor: colors.line, borderRadius: 4, paddingHorizontal: 5, paddingVertical: 2 },
  resultName: { marginTop: 4, color: colors.ink, fontSize: 17, fontWeight: "700" },
  resultMeta: { marginTop: 3, color: colors.inkSoft, fontSize: 10 },
  resultLocation: { marginTop: 8, color: colors.cyan, fontSize: 10, fontWeight: "600" },
  resultDetail: { marginTop: 3, color: colors.inkDim, fontSize: 9, lineHeight: 14 },
  lastSeen: { maxWidth: 180, color: colors.inkDim, fontFamily: fontFamilies.mono, fontSize: 7, lineHeight: 13, textAlign: "right" },
  reportActions: {
    width: "100%",
    flexDirection: "row",
    flexWrap: "wrap",
